...
function NewsletterSection() {
    return (
        <section className=" p-9 flex flex-col items-center gap-7 justify-center">
            ...
            <p className=" text-[#9EA3AE]">Join <span className='text-primary font-semi-bold'>10,000+</span>  other landlords in our estatery community.</p>
            <Space className='text-center align-center' direction="horizontal" size="large">
                <div className=' flex justify-between  items-center px-11 rounded-3xl gap-x-48 bg-[#F2F2F3]' >
                    <Input placeholder='Enter your email address'
                        ...
                        className="placeholder-[#8E8E93] text-sm py-9 bg-transparent flex-1 h-[40px] rounded-md text-lg  bg-white"
                    />
                    <Button type="primary"
