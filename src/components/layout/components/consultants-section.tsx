...
function ConsultantsSection() {
    ...
    return (
        <section className='p-9 text-center'>
            ...
            <p className='py-4 text-[#8E8E93] font-sm'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel lobortis justo</p>
            ...
            <div className=' w-[75%] rounded-3xl mx-auto flex flex-row align-center justify-between bg-[#FD1E2812] p-7'>
                <div className='flex align-center items-center space-x-4'>
                    ...
                    <p className='text-[#8E8E93] text-lg'>Don’t know where to start? Get an expert consultation!</p></div>
                </div>
                <button className='bg-primary text-white text-xl font-normal px-11  rounded-lg font-medium  text-sm'>
                    Contact Us
                </button>
            </div>
        </section>
