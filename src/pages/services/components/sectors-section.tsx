        ...
        <div>
            <Container>
                <div className="py-6 flex flex-col gap-4 max-w-[70%] items-start">
                    ...
                    <p className="opacity-[70%] font-normal text-xl">Lorem ipsum dolor sit amet consectetur. Eu convallis amet mattis pulvinar odio felis mattis porttitor nisl. Quisque ac ultrices vel amet. Elit dolor eget nec aliquam nibh diam</p>
                </div>
                <div className=" py-9 mt-18  grid grid-cols-3 justify-center mx-auto items-center gap-9">
                    {Sectors?.map((sector, index) => (

                        <div key={sector.id} className={`flex flex-col gap-2 px-8 py-11 mx-auto  h-[18rem] border-2 rounded-3xl ${sector?.id === 12 ? 'gap-5 text-center text-white bg-primary flex-centered' : ' hover:bg-[#24252CE5] hover:text-white'}`}>
                        ...
                        <button className="bg-white py-3 px-9 font-medium rounded-3xl text-black">
                            Let’s Talk
                        </button>
                        }
                        </div>
