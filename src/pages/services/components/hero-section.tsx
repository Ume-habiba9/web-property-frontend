    ...
    >
      <Container>
        <div className="flex mx-auto flex-col items-center justify-center align-center">
          ...
          <p className="text-2xl font-normal text-center mx-auto lg:px-[12rem] md:px-[19rem] sm:px-5 px-[12rem]">Lorem ipsum dolor sit amet consectetur. Sit at nisl etiam diam pretium sagittis massa aliquam. Dignissim vivamus fermentum.</p>
        </div>
      </Container>
    </div>
  )
