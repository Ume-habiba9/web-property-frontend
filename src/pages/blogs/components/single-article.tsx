    ...
    <div>
      <div className='flex text-left flex-col p-9 gap-4'>
        <div className='flex justify-between gap-3'>
          ...
          <button
            onClick={goBack}
            className='border-2 border-[#8E8E93] rounded-full py-3 px-6 flex gap-2 text-[#8E8E93]'
          >
            Go Back
          </button>
        </div>
        ...
        <div className='mx-48 py-11 align-center font-primary text-[#3B3C4A] flex flex-col text-left text-xl gap-3'>
          <p className='pb-9 leading-7'>
            Lorem ipsum dolor sit amet consectetur. Aenean gravida nec magna et habitant lorem integer eget. Eget elit
            diam blandit mattis porttitor neque eget nisl. Facilisis eu et sit venenatis massa eu neque sit. Risus et at
            tristique facilisi faucibus volutpat viverra mi. A sed massa at scelerisque in sed. Massa tellus enim
            elementum ac maecenas lacus quam vitae mi. Ullamcorper sem vulputate diam lacus rhoncus. Lectus elit orci
            accumsan mus nulla fermentum in. Commodo eu dis at habitant dui vitae.\{' '}
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur. Aenean gravida nec magna et habitant lorem integer eget. Eget elit
            diam blandit mattis porttitor neque eget nisl. Facilisis eu et sit venenatis massa eu neque sit. Risus et at
          ...
          <h3 className='rounded-md font-tertiary italic bg-[#F6F6F7] px-11 py-6'>
