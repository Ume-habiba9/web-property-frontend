  ...
  return (
    <div className='my-28 w-full mx-auto'>
      <div className='flex-centered flex-col gap-4   mx-auto text-center max-w-[670px] '>
        <span className='text-primary font-normal font-primary text-2xl '>~ WHY US</span>
        <h2 className='text-5xl font-semibold'>Why Choose IVYHOLD?</h2>
        <p className='leading-7 '>
          At IVYHOLD, we understand that every property has a unique story to tell, and we’re committed to showcasing
          yours in a way that captivates the right audience. With a proven track record in delivering exceptional
          results, we utilize our global reach and local expertise to ensure your property gets the attention it
          deserves.
        </p>
      </div>
