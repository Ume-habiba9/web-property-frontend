...
import { Form, Row, Col, Button, Input, Carousel, Select } from "antd";
            ...
            <Container>
                <div className="p-9 flex-centered text-center">
                    <div className="mt-9 max-w-[830px] text-white flex flex-col gap-5">
                        ...
                        <p className="text-base leading-9">Lorem ipsum dolor sit amet consectetur. Ridiculus at mauris diam ut. Cum ullamcorper urna quis vestibulum ut. Massa proin gravida arcu sed id. Dictum facilisi vel facilisis elementum augue. Id facilisis aliquam dolor aliquam.</p>
                    </div>

                </div>

                <div className="mx-auto py-7 px-14 bg-white max-w-[710px]  rounded-3xl">
                    <span onClick={handleBack}><FaArrowLeftLong /></span>
                    <Carousel ref={carouselRef} dotPosition="top" infinite={false}>
                        <div>
                            ...
                            >
                                <Row gutter={48}>
                                    <Col span={10}>
                                        <Form.Item label={<span className='font-primary text-sm font-medium'>Full Name</span>} name='fullName'>
                                            <Input
                                                placeholder='John'
